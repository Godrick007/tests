...
public class MutiRender implements EGLSurfaceView.EGLRender {
    ...
    public void onSurfaceCreated() {
        ...
        String textureSource = ShaderUtil.readRawText(context, textureResId);
...
//        GLES20.glUniformMatrix4fv(u_matrix,1,false,matrix,0);
    ...
    public void setTextureId(int textureId,int textureResId) {
